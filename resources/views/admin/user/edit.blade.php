                    ...
                    <div class="card-body">
                        ...
                        <form action="{{route('users.update',['id'=>$users->id])}}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" value="{{$users->name}}" name="name" class="form-control border-1 " placeholder="Nhập tên user..">
                            </div>
                            <div class="mb-3">
                                <label class="form-label">Email</label>
                                <input type="email" value="{{$users->email}}" name="email" class="form-control border-1 " placeholder="Nhập email..">
                            </div>
                            <div class="mb-3">
